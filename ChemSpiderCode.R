...
setClass( 'ECompression' ,
	   representation(
		.Data = 'character') ,
	   contains = c( 'character' )
 ) 
setAs('XMLAbstractNode', 'ECompression',


function (from, to = "ECompression", strict = TRUE) 
new("ECompression", from)


)
setAs('XMLInternalElementNode', 'ECompression',
...
setAs('XMLInternalElementNode', 'ArrayOfInt',


function (from, to = "ArrayOfInt", strict = TRUE) 
xmlSApply(from, as, "integer")


)
setAs('character', 'ArrayOfInt',


function (from, to = "ArrayOfInt", strict = TRUE) 
new("ArrayOfInt", as(from, "character"))


)
setAs('integer', 'ArrayOfInt',


function (from, to = "ArrayOfInt", strict = TRUE) 
new("ArrayOfInt", as(from, "numeric"))


)
setAs('numeric', 'ArrayOfInt',
...
setAs('logical', 'ArrayOfInt',


function (from, to = "ArrayOfInt", strict = TRUE) 
new("ArrayOfInt", as(from, "logical"))
...
setAs('XMLInternalElementNode', 'ArrayOfExtendedCompoundInfo',


function (from, to = "ArrayOfExtendedCompoundInfo", strict = TRUE) 
xmlSApply(from, as, "ExtendedCompoundInfo")
        ...
        xmlns = "http://www.chemspider.com/", .types = list(parameters = new("Element", 
            type = new("ClassDefinition", slotTypes = list(rid = new("PrimitiveSOAPType", 
                ...
                eComp = new("RestrictedStringDefinition", values = "eGzip", 
                  ...
                  new("ECompression", from), toConverter = function (from) 
